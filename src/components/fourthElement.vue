    ...
    <div class="row">
      ...
      <div class="col s3 m3">
        <div class="currWrap card">
          <div class="card-content">
            <p>貿易資訊：</p>
            <v-select :options="tradeoptions" placeholder="請選擇" v-model="tradeinfo"></v-select>
          </div>
        </div>
      </div>
...
import imdata from '../js/store/JSON_year_im_avg.json'
...
//  name: 'linePlatform',
  ...
  watch:{
    tradeinfo: function(){
      if (this.tradeinfo.value == 'import'){
        this.data = imdata
      } else if (this.tradeinfo.value == 'export'){
        this.data = data
      }
    }
  },
