      ...
      <div class="col s12 m12">
        <div class="card">
          <div class="card-content" v-if="currencyData">
            ...
            <div class="LinechartWrap" v-if="chartData" v-for="(d, index) in chartData">
             ...
             <div class="textTableWrap" style="outline:5px solid black">
...
import currencyList2 from './currencyList2.vue';
...
export default {
  ...
  data() {
    return {
      currency2: this.$route.params.selectedCurrency,
      date: '',
      data,
      currency: '',
      lineChartOptions: {
  ...
  mounted(){
    console.log('value of currency2:',this.currency2)
    console.log('hi2')
